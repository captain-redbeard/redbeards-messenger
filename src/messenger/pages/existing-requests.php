...
$requests = QB::select("SELECT request_guid, request_name, expire, DATE_ADD(made_date, INTERVAL expire HOUR) as expiretime FROM contact_requests WHERE user_guid = ?;",
